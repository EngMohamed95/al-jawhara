...
try {
    ...
    $pdo->exec("UPDATE site_content SET heroVideoUrl = '/videos/herosection.mp4' WHERE id = 1 AND (heroVideoUrl IS NULL OR heroVideoUrl = '' OR heroVideoUrl = '/JawharaNewIntro.mp4' OR heroVideoUrl = '/videos/الجوهرة.mp4' OR heroVideoUrl = '/videos/jawhara-hero.mp4' OR heroVideoUrl = '/videos/AlJawharaUV.mp4');");
